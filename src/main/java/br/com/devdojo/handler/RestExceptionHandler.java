...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException manValidException,
                                                               HttpHeaders headers,
                                                               HttpStatus status,
                                                               WebRequest request) {

        List<FieldError> fieldErrors = manValidException.getBindingResult().getFieldErrors();
        ...
        ValidationErrorDetails rnfDetails = ValidationErrorDetails.Builder
                ...
                .developerMessage(manValidException.getClass().getName())
                .field(fields)
